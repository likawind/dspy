...
Note that the `extract` function has been updated to truncate raw predictions, which can improve the accuracy of the predicted answers by removing any extraneous input fields included in the completion.
